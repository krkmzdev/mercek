      ...
      <main className="mx-auto max-w-2xl px-6 py-14">
        ...
        <header className="mt-6">
          ...
          <h1 className="mt-2 text-3xl font-semibold tracking-tight">
            {uploadsEnabled ? 'Verini analiz et' : 'Örnek raporu incele'}
          </h1>
        ...
        {uploadsEnabled ? (
          ...
          <div className="mt-4 rounded-xl border border-warning/30 bg-warning/10 p-4">
            <p className="text-sm font-medium text-fg">Bu canlı bir demo</p>
            <p className="mt-1.5 text-sm text-muted">
              Dosya yükleme şu an kapalı; demo sentetik örnek verilerle çalışıyor. Aşağıdaki
              hazır raporda motorun bu sektör için ürettiği gerçek çıktıyı inceleyebilirsin.
            </p>
          </div>
        )}
        ...
        >
          <span>
            <span className="text-sm font-medium">
              {uploadsEnabled ? 'Önce örnek veriyle dene' : 'Örnek veriyle hazırlanmış rapor'}
            </span>
