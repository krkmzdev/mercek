...
const SECTORS: Sector[] = [
  ...
  { id: 'FNB', name: 'Restoran / F&B', desc: 'POS, menü karlılığı, food cost.', inputs: 'POS satır verisi', ready: false },
  { id: 'FINANCE', name: 'KOBİ Finans', desc: 'Mizan, nakit akışı, TÜFE-reel büyüme.', inputs: 'mizan / gelir tablosu', ready: false },
